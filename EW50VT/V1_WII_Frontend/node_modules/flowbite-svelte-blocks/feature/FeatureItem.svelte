...
export let divClass = 'flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900';
...
<div>
	...
	{/if}
	{#if $$slots.h3}
		<h3 class={classNames(h3Class, $$props.classh3)}><slot name="h3" /></h3>
	{/if}
	{#if $$slots.paragraph}
