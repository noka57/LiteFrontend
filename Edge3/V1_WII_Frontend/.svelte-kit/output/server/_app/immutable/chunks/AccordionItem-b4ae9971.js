import { c as create_ssr_component, s as setContext, v as validate_component, b as compute_rest_props, d as spread, h as escape_attribute_value, f as escape_object, g as getContext, k as subscribe, i as add_attribute } from "./index-54377ec4.js";
...
const AccordionItem = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<h2 class="group"><button type="button"${add_attribute("class", buttonClass, 0)}>${open ? `${slots.arrowup ? slots.arrowup({}) : `${validate_component(ChevronUp, "ChevronUp").$$render($$result, {}, {}, {})}`}` : `${slots.arrowdown ? slots.arrowdown({}) : `${validate_component(ChevronDown, "ChevronDown").$$render($$result, {}, {}, {})}`}`}
