...
<tr><td class="text-right"></td>
      <td class="pl-4 pt-4" colspan="5">${NewActionSMS[new_action_sms_index].smsContentType == 0 ? `<textarea id="textarea-id" rows="12" class="w-full rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:placeholder-gray-400 dark:text-white border border-gray-200 dark:border-gray-600 disabled:cursor-not-allowed disabled:opacity-50 p-2.5 p-2.5 text-sm focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-500 dark:focus:border-blue-500" disabled>${escape(NewActionSMS[new_action_sms_index].smsContent || "")}</textarea>` : `${NewActionSMS[new_action_sms_index].smsContentType == 1 ? `<textarea id="textarea-id" rows="12" class="w-full rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:placeholder-gray-400 dark:text-white border border-gray-200 dark:border-gray-600 disabled:cursor-not-allowed disabled:opacity-50 p-2.5 p-2.5 text-sm focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-500 dark:focus:border-blue-500">${escape(NewActionSMS[new_action_sms_index].smsContent || "")}</textarea>` : ``}`}</td></tr>
...
<tr><td class="text-right"></td>
      <td class="pl-4 pt-4" colspan="5">${changed_event_engine_data.config.service_eventEngine_actionProfile.sms[modify_action_sms_index].smsContentType == 0 ? `<textarea id="textarea-id" rows="12" class="w-full rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:placeholder-gray-400 dark:text-white border border-gray-200 dark:border-gray-600 disabled:cursor-not-allowed disabled:opacity-50 p-2.5 p-2.5 text-sm focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-500 dark:focus:border-blue-500" disabled>${escape(changed_event_engine_data.config.service_eventEngine_actionProfile.sms[modify_action_sms_index].smsContent || "")}</textarea>` : `${changed_event_engine_data.config.service_eventEngine_actionProfile.sms[modify_action_sms_index].smsContentType == 1 ? `<textarea id="textarea-id" rows="12" class="w-full rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:placeholder-gray-400 dark:text-white border border-gray-200 dark:border-gray-600 disabled:cursor-not-allowed disabled:opacity-50 p-2.5 p-2.5 text-sm focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-500 dark:focus:border-blue-500">${escape(changed_event_engine_data.config.service_eventEngine_actionProfile.sms[modify_action_sms_index].smsContent || "")}</textarea>` : ``}`}</td></tr>
