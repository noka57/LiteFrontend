  ...
  const btn5 = () => 
 {
  ...
  function NewTagClick(CloudIndex, TagIndex)
    ...
    function new_monitor_edge_trigger(index)
    {
        ...
        new_monitor_edge[index].display=0;
...
<Tooltip triggeredBy="#hover">&#123;TIME:$TIME$, $ARRAY$&#125;</Tooltip></Radio>
...
<nav use:getContextMenuDimension style="position: absolute; top:{pos.y}px; left:{pos.x}px;padding: 0;margin: 0;">
    <div id="navbar" style="display: inline-flex;border: 1px #999 solid;width: 300px;background-color: #fff;border-radius: 10px;overflow: hidden;flex-direction: column;padding: 0;margin: 0;">
        <ul style="margin: 6px;">
              ...
              <li style="display: block;list-style-type: none;width: 1fr;">
                    <button class="ContextMenu" on:click|preventDefault={()=>NewModbusReqClick(0)}><i style="padding: 0px 15px 0px 10px;"></i>$MODBUSREQ$</button></li>
              <li style="display: block;list-style-type: none;width: 1fr;">
                    <button class="ContextMenu" on:click|preventDefault={()=>NewModbusResClick(0)}><i style="padding: 0px 15px 0px 10px;"></i>$MODBUSRESP$</button></li>
...
<nav use:getContextMenuDimension style="position: absolute; top:{pos.y}px; left:{pos.x}px;padding: 0;margin: 0;">
    <div id="navbar" style="display: inline-flex;border: 1px #999 solid;width: 300px;background-color: #fff;border-radius: 10px;overflow: hidden;flex-direction: column;padding: 0;margin: 0;">
        <ul style="margin: 6px;">
              ...
              <li style="display: block;list-style-type: none;width: 1fr;">
                    <button class="ContextMenu" on:click|preventDefault={()=>NewModbusReqClick(1)}><i style="padding: 0px 15px 0px 10px;"></i>$MODBUSREQ$</button></li>
              <li style="display: block;list-style-type: none;width: 1fr;">
                    <button class="ContextMenu" on:click|preventDefault={()=>NewModbusResClick(1)}><i style="padding: 0px 15px 0px 10px;"></i>$MODBUSRESP$</button></li>
...
<nav use:getContextMenuDimension style="position: absolute; top:{pos.y}px; left:{pos.x}px;padding: 0;margin: 0;">
    <div id="navbar" style="display: inline-flex;border: 1px #999 solid;width: 300px;background-color: #fff;border-radius: 10px;overflow: hidden;flex-direction: column;padding: 0;margin: 0;">
        <ul style="margin: 6px;">
              ...
              <li style="display: block;list-style-type: none;width: 1fr;">
                    <button class="ContextMenu" on:click|preventDefault={()=>ModifyModbusReqClick(0)}><i style="padding: 0px 15px 0px 10px;"></i>$MODBUSREQ$</button></li>
              <li style="display: block;list-style-type: none;width: 1fr;">
                    <button class="ContextMenu" on:click|preventDefault={()=>ModifyModbusResClick(0)}><i style="padding: 0px 15px 0px 10px;"></i>$MODBUSRESP$</button></li>
...
<nav use:getContextMenuDimension style="position: absolute; top:{pos.y}px; left:{pos.x}px;padding: 0;margin: 0;">
    <div id="navbar" style="display: inline-flex;border: 1px #999 solid;width: 300px;background-color: #fff;border-radius: 10px;overflow: hidden;flex-direction: column;padding: 0;margin: 0;">
        <ul style="margin: 6px;">
              ...
              <li style="display: block;list-style-type: none;width: 1fr;">
                    <button class="ContextMenu" on:click|preventDefault={()=>ModifyModbusReqClick(1)}><i style="padding: 0px 15px 0px 10px;"></i>$MODBUSREQ$</button></li>
              <li style="display: block;list-style-type: none;width: 1fr;">
                    <button class="ContextMenu" on:click|preventDefault={()=>ModifyModbusResClick(1)}><i style="padding: 0px 15px 0px 10px;"></i>$MODBUSRESP$</button></li>
