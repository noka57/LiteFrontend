...
find -maxdepth 1 -type f -name "Login_2.png" -printf "\"/%P\",%s,3,\"/usr/sbin/litebackendEW50v/%P\"\r\n" >> ../gperffile/webfileGperf
find -maxdepth 1 -type f -name "index.html" -printf "\"/%P\",%s,1,\"/usr/sbin/litebackendEW50v/%P\"\r\n" >> ../gperffile/webfileGperf
find -maxdepth 1 -type f -name "global.css" -printf "\"/%P\",%s,2,\"/usr/sbin/litebackendEW50v/%P\"\r\n" >> ../gperffile/webfileGperf
find -mindepth 2 -type f -name "bundle.js" -printf "\"/%P\",%s,4,\"/usr/sbin/litebackendEW50v/%P\"\r\n" >> ../gperffile/webfileGperf
find -mindepth 2 -type f -name "bundle.css" -printf "\"/%P\",%s,2,\"/usr/sbin/litebackendEW50v/%P\"\r\n" >> ../gperffile/webfileGperf