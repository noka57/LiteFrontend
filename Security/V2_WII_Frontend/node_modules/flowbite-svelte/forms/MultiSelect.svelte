...
{
    console.log("clearThisOption");
    console.log(select);
    if (selectItems.includes(select)) 
    {
        console.log("selectItems.includes");
...
<div on:click={() => (show = !show)} on:focusout={() => (show = false)} tabindex="-1" role="listbox" class={twMerge($$restProps,multiSelectClass, sizes[size], $$props.class)}>
