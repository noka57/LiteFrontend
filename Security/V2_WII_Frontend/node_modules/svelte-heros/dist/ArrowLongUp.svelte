...
let svgpath;
let svgoutline = `<path d="M8.25 6.75L12 3M12 3L15.75 6.75M12 3V21" stroke="${color}" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/> `;
...
export let ariaLabel = "arrow long up";
</script>
