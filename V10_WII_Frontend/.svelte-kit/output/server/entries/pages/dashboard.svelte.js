...
import "classnames";
/* empty css                                                                            */import { T as Table, a as TableBody, b as TableBodyRow, c as TableBodyCell } from "../../_app/immutable/chunks/TableBodyRow-53df767c.js";
...
<p class="${"text-xl font-bold"}">${dashboard_data != "" ? `${escape(dashboard_data.config.dashboard.internetUptime)} s` : ``}</p></div></div>`;
                }
              })}
      ${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, { tdStyle, tdClass }, {}, {
                default: () => {
...
<p class="${"text-xl font-bold"}">${dashboard_data != "" ? `${escape(parseFloat(dashboard_data.config.dashboard.gpsInfo.lat).toFixed(2))}, ${escape(parseFloat(dashboard_data.config.dashboard.gpsInfo.long).toFixed(2))}, ${escape(parseFloat(dashboard_data.config.dashboard.gpsInfo.alt).toFixed(2))}` : ``}</p></div></div>`;
                }
              })}`;
            }
          })}
...
<div class="${"pl-20"}"><p class="${"text-black text-lg text-center"}">${dashboard_data != "" ? `${escape(dashboard_data.config.dashboard.ethernet.lan[1].name)}` : ``}</p>
${dashboard_data != "" ? `${dashboard_data.config.dashboard.ethernet.lan[1].status ? `<svg xmlns="${"http://www.w3.org/2000/svg"}" viewBox="${"-5 -5 24 24"}" class="${"w-16 h-16"}"><path fill="${"blue"}" d="${"M11.3,2.6V1.4h-1.1V0h-7v1.4H2.2v1.2H0v7.6h13.5V2.6H11.3z M3,8.3H2.2V6.4H3V8.3z M4.7,8.3H3.8V6.4h0.8V8.3z\n     M6.3,8.3H5.5V6.4h0.8V8.3z M8,8.3H7.2V6.4H8V8.3z M9.7,8.3H8.8V6.4h0.8V8.3z M11.3,8.3h-0.8V6.4h0.8V8.3z"}"></path></svg>` : `<svg xmlns="${"http://www.w3.org/2000/svg"}" viewBox="${"-5 -5 24 24"}" class="${"w-16 h-16"}"><path fill="${"none"}" d="${"M10.6,3.4V2.6V2.1h-0.3H9.5V1.4V0.8H4v0.6v0.8H3.2H2.9v0.4v0.8H2.1H0.8v6.1h11.9V3.4h-1.4H10.6z M3,8.3H2.2\n    V6.4H3V8.3z M4.7,8.3H3.8V6.4h0.8V8.3z M6.3,8.3H5.5V6.4h0.8V8.3z M8,8.3H7.2V6.4H8V8.3z M9.7,8.3H8.8V6.4h0.8V8.3z M11.3,8.3h-0.8\n    V6.4h0.8V8.3z"}"></path><path fill="${"#D0D0D0"}" d="${"M11.3,2.6V1.4h-1.1V0h-7v1.4H2.2v1.2H0v7.6h13.5V2.6H11.3z M12.7,9.4H0.8V3.4h1.4h0.8V2.6V2.2h0.3H4V1.4V0.8\n    h5.5v0.6v0.8h0.8h0.3v0.4v0.8h0.8h1.4L12.7,9.4L12.7,9.4z"}"></path><rect x="${"2.2"}" y="${"6.4"}" fill="${"#D0D0D0"}" width="${"0.8"}" height="${"1.9"}"></rect><rect x="${"3.8"}" y="${"6.4"}" fill="${"#D0D0D0"}" width="${"0.8"}" height="${"1.9"}"></rect><rect x="${"5.5"}" y="${"6.4"}" fill="${"#D0D0D0"}" width="${"0.8"}" height="${"1.9"}"></rect><rect x="${"7.2"}" y="${"6.4"}" fill="${"#D0D0D0"}" width="${"0.8"}" height="${"1.9"}"></rect><rect x="${"8.8"}" y="${"6.4"}" fill="${"#D0D0D0"}" width="${"0.8"}" height="${"1.9"}"></rect><rect x="${"10.5"}" y="${"6.4"}" fill="${"#D0D0D0"}" width="${"0.8"}" height="${"1.9"}"></rect></svg>`}` : ``}</div>

<div class="${"pl-20"}"><p class="${"text-black text-lg text-center"}">${dashboard_data != "" ? `${escape(dashboard_data.config.dashboard.ethernet.lan[2].name)}` : ``}</p>
${dashboard_data != "" ? `${dashboard_data.config.dashboard.ethernet.lan[2].status ? `<svg xmlns="${"http://www.w3.org/2000/svg"}" viewBox="${"-5 -5 24 24"}" class="${"w-16 h-16"}"><path fill="${"blue"}" d="${"M11.3,2.6V1.4h-1.1V0h-7v1.4H2.2v1.2H0v7.6h13.5V2.6H11.3z M3,8.3H2.2V6.4H3V8.3z M4.7,8.3H3.8V6.4h0.8V8.3z\n     M6.3,8.3H5.5V6.4h0.8V8.3z M8,8.3H7.2V6.4H8V8.3z M9.7,8.3H8.8V6.4h0.8V8.3z M11.3,8.3h-0.8V6.4h0.8V8.3z"}"></path></svg>` : `<svg xmlns="${"http://www.w3.org/2000/svg"}" viewBox="${"-5 -5 24 24"}" class="${"w-16 h-16"}"><path fill="${"none"}" d="${"M10.6,3.4V2.6V2.1h-0.3H9.5V1.4V0.8H4v0.6v0.8H3.2H2.9v0.4v0.8H2.1H0.8v6.1h11.9V3.4h-1.4H10.6z M3,8.3H2.2\n    V6.4H3V8.3z M4.7,8.3H3.8V6.4h0.8V8.3z M6.3,8.3H5.5V6.4h0.8V8.3z M8,8.3H7.2V6.4H8V8.3z M9.7,8.3H8.8V6.4h0.8V8.3z M11.3,8.3h-0.8\n    V6.4h0.8V8.3z"}"></path><path fill="${"#D0D0D0"}" d="${"M11.3,2.6V1.4h-1.1V0h-7v1.4H2.2v1.2H0v7.6h13.5V2.6H11.3z M12.7,9.4H0.8V3.4h1.4h0.8V2.6V2.2h0.3H4V1.4V0.8\n    h5.5v0.6v0.8h0.8h0.3v0.4v0.8h0.8h1.4L12.7,9.4L12.7,9.4z"}"></path><rect x="${"2.2"}" y="${"6.4"}" fill="${"#D0D0D0"}" width="${"0.8"}" height="${"1.9"}"></rect><rect x="${"3.8"}" y="${"6.4"}" fill="${"#D0D0D0"}" width="${"0.8"}" height="${"1.9"}"></rect><rect x="${"5.5"}" y="${"6.4"}" fill="${"#D0D0D0"}" width="${"0.8"}" height="${"1.9"}"></rect><rect x="${"7.2"}" y="${"6.4"}" fill="${"#D0D0D0"}" width="${"0.8"}" height="${"1.9"}"></rect><rect x="${"8.8"}" y="${"6.4"}" fill="${"#D0D0D0"}" width="${"0.8"}" height="${"1.9"}"></rect><rect x="${"10.5"}" y="${"6.4"}" fill="${"#D0D0D0"}" width="${"0.8"}" height="${"1.9"}"></rect></svg>`}` : ``}</div>

<div class="${"pl-20"}"><p class="${"text-black text-lg text-center"}">${dashboard_data != "" ? `${escape(dashboard_data.config.dashboard.ethernet.lan[3].name)}` : ``}</p>
${dashboard_data != "" ? `${dashboard_data.config.dashboard.ethernet.lan[3].status ? `<svg xmlns="${"http://www.w3.org/2000/svg"}" viewBox="${"-5 -5 24 24"}" class="${"w-16 h-16"}"><path fill="${"blue"}" d="${"M11.3,2.6V1.4h-1.1V0h-7v1.4H2.2v1.2H0v7.6h13.5V2.6H11.3z M3,8.3H2.2V6.4H3V8.3z M4.7,8.3H3.8V6.4h0.8V8.3z\n     M6.3,8.3H5.5V6.4h0.8V8.3z M8,8.3H7.2V6.4H8V8.3z M9.7,8.3H8.8V6.4h0.8V8.3z M11.3,8.3h-0.8V6.4h0.8V8.3z"}"></path></svg>` : `<svg xmlns="${"http://www.w3.org/2000/svg"}" viewBox="${"-5 -5 24 24"}" class="${"w-16 h-16"}"><path fill="${"none"}" d="${"M10.6,3.4V2.6V2.1h-0.3H9.5V1.4V0.8H4v0.6v0.8H3.2H2.9v0.4v0.8H2.1H0.8v6.1h11.9V3.4h-1.4H10.6z M3,8.3H2.2\n    V6.4H3V8.3z M4.7,8.3H3.8V6.4h0.8V8.3z M6.3,8.3H5.5V6.4h0.8V8.3z M8,8.3H7.2V6.4H8V8.3z M9.7,8.3H8.8V6.4h0.8V8.3z M11.3,8.3h-0.8\n    V6.4h0.8V8.3z"}"></path><path fill="${"#D0D0D0"}" d="${"M11.3,2.6V1.4h-1.1V0h-7v1.4H2.2v1.2H0v7.6h13.5V2.6H11.3z M12.7,9.4H0.8V3.4h1.4h0.8V2.6V2.2h0.3H4V1.4V0.8\n    h5.5v0.6v0.8h0.8h0.3v0.4v0.8h0.8h1.4L12.7,9.4L12.7,9.4z"}"></path><rect x="${"2.2"}" y="${"6.4"}" fill="${"#D0D0D0"}" width="${"0.8"}" height="${"1.9"}"></rect><rect x="${"3.8"}" y="${"6.4"}" fill="${"#D0D0D0"}" width="${"0.8"}" height="${"1.9"}"></rect><rect x="${"5.5"}" y="${"6.4"}" fill="${"#D0D0D0"}" width="${"0.8"}" height="${"1.9"}"></rect><rect x="${"7.2"}" y="${"6.4"}" fill="${"#D0D0D0"}" width="${"0.8"}" height="${"1.9"}"></rect><rect x="${"8.8"}" y="${"6.4"}" fill="${"#D0D0D0"}" width="${"0.8"}" height="${"1.9"}"></rect><rect x="${"10.5"}" y="${"6.4"}" fill="${"#D0D0D0"}" width="${"0.8"}" height="${"1.9"}"></rect></svg>`}` : ``}</div>
 ...
 ${validate_component(TableBodyRow, "TableBodyRow").$$render($$result, {}, {}, {
            ...
            default: () => {
              return `${validate_component(TableBodyCell, "TableBodyCell").$$render(
                ...
                {
                  default: () => {
                    return `<div class="${"flex"}"><div class="${"pb-20"}"><p class="${"text-black text-sm text-center"}">${dashboard_data != "" ? `${escape(dashboard_data.config.dashboard.systemResource.cpuRemaining)}` : ``}</p>${validate_component(CircleProgressBar, "ProgressCircle").$$render($$result, { max: "100", value: value1, color: "blue" }, {}, {})}
         ...
         ${validate_component(TableBodyRow, "TableBodyRow").$$render($$result, {}, {}, {
            ...
            default: () => {
              return `${validate_component(TableBodyCell, "TableBodyCell").$$render(
                ...
                {
                  default: () => {
                    return `<div class="${"flex"}"><div class="${"px-10"}"><p class="${"text-black text-lg"}"></p>
        <p class="${"text-black text-lg"}"></p></div>
<div class="${"px-40"}"><p class="${"text-lg font-light"}"></p>
<p class="${"text-lg font-light"}"></p></div></div>`;
                  }
                }
              )}
