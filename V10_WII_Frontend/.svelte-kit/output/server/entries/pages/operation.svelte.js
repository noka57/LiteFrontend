import { c as create_ssr_component, q as createEventDispatcher, r as get_current_component, i as add_attribute, e as escape, o as each, v as validate_component } from "../../_app/immutable/chunks/index-a89b87ed.js";
import "classnames";
...
const Operation = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    <td class="${"pl-5 pt-5"}">${escape(dateString)}</td></tr>
...
<tr><td class="${"w-85"}"><p class="${"pl-10 pt-5 text-lg font-light text-right"}">Time Zone</p></td>
    <td class="${"w-85 pt-5 pl-5"}">${validate_component(Picker, "TimezonePicker").$$render($$result, {}, {}, {})}</td></tr>
