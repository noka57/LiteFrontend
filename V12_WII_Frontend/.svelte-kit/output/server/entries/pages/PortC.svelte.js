...
<table><tr><td><p class="${"pl-4 pt-4 text-lg font-light text-right"}">Serial Profile</p></td>
      ...
      <td class="${"pl-5 pt-5"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", changed_port_connection_data.config.fieldManagement_portConnection_com[modify_com_index].serialProfile, 0)}></td></tr>
...
<tr><td><p class="${"pl-4 pt-4 text-lg font-light text-right"}">Stop Bits</p></td><td class="${"pl-5 pt-5"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", changed_port_connection_data.config.fieldManagement_portConnection_com[modify_com_index].stopBits, 0)}></td></tr>
  ...
  ${validate_component(TabItem, "TabItem").$$render($$result, { title: "Simulator" }, {}, {
          default: () => {
            return `<table><tr><td class="${"pl-10"}">${validate_component(Button, "Button").$$render($$result, { pill: true }, {}, {
              default: () => {
                return `Test DI`;
              }
            })}</td></tr>
...
<tr><td class="${"pl-10"}">${validate_component(Button, "Button").$$render($$result, { pill: true }, {}, {
              default: () => {
                return `Test DO High`;
              }
            })}</td></tr>
