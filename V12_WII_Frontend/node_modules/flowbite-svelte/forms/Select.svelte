...
let selectClass;
$: selectClass = classNames(SNWfull?common24:common, underline ? underlineClass : defaultClass, sizes[size], underline && '!px-0', $$restProps.class);
</script>
