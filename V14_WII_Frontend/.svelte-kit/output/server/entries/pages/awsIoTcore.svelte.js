...
import { sdataLoggerConfig, ChangedSDataLoggerConfig, awsIoTcoreConfig, AWSIoTcoreConfigChangedLog, ChangedAWSIoTcoreConfig, eventEngineConfig, ChangedEventEngineConfig, SDatalogger_ProxyMode_Cloud_ConfigChangedLog, SDatalogger_MonitorMode_Cloud_ConfigChangedLog, EventEngine_TriggerMQTT_ConfigChangedLog, EventEngine_ActionMQTT_ConfigChangedLog } from "../endpoints/configG.js";
...
const awsIoTcore_svelte_svelte_type_style_lang = "";
const css = {
...
<table><tr><td><p class="${"pl-20 pt-4 text-lg font-light text-right"}">Broker Host</p></td><td class="${"pl-5 pt-5"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", changed_awsIoT_core_data.config.cloud_awsIoTcore_profile[modify_index].brokerHost, 0)}></td></tr>


<tr><td><p class="${"pl-20 pt-4 text-lg font-light text-right"}">Broker Port</p></td><td class="${"pl-5 pt-5"}"><input type="${"number"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", changed_awsIoT_core_data.config.cloud_awsIoTcore_profile[modify_index].brokerPort, 0)}></td></tr>
...
<tr><td><p class="${"pl-20 pt-4 text-lg font-light text-right"}">Broker CA Certificate</p></td>
    <td class="${"pl-4 pt-4"}">${changed_awsIoT_core_data.config.cloud_awsIoTcore_profile[modify_index].tls == 0 ? `None` : `${changed_awsIoT_core_data.config.cloud_awsIoTcore_profile[modify_index].tls == 1 ? `<select class="${"block text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 text-sm p-2.5 mt-2 mb-4 w-48"}"><option disabled="${""}" value="${"none"}">Choose Certificate ...</option>${``}</select>` : ``}`}</td></tr>

<tr><td><p class="${"pl-20 pt-4 text-lg font-light text-right"}">Local Certificate</p></td>
    <td class="${"pl-4 pt-4"}">${changed_awsIoT_core_data.config.cloud_awsIoTcore_profile[modify_index].tls == 0 ? `None` : `${changed_awsIoT_core_data.config.cloud_awsIoTcore_profile[modify_index].tls == 1 ? `<select class="${"block text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 text-sm p-2.5 mt-2 mb-4 w-48"}"><option disabled="${""}" value="${"none"}">Choose Certificate ...</option>${``}</select>` : ``}`}</td></tr>


<tr><td><p class="${"pl-20 pt-4 text-lg font-light text-right"}">Client ID</p></td><td class="${"pl-5 pt-5"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", changed_awsIoT_core_data.config.cloud_awsIoTcore_profile[modify_index].clientId, 0)}></td></tr>



<tr><td><p class="${"pl-20 pt-4 text-lg font-light text-right"}">Account</p></td><td class="${"pl-5 pt-5"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", changed_awsIoT_core_data.config.cloud_awsIoTcore_profile[modify_index].account, 0)}></td></tr>

<tr><td><p class="${"pl-20 pt-4 text-lg font-light text-right"}">Password</p></td><td class="${"pl-5 pt-5"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", changed_awsIoT_core_data.config.cloud_awsIoTcore_profile[modify_index].password, 0)}></td></tr>


<tr><td><p class="${"pl-20 pt-4 text-lg font-light text-right"}">QoS</p></td><td class="${"pl-5 pt-5"}"><input type="${"number"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", changed_awsIoT_core_data.config.cloud_awsIoTcore_profile[modify_index].qos, 0)}></td></tr>
...
<tr><td><p class="${"pl-20 pt-4 text-lg font-light text-right"}">Keep Alive Interval</p></td><td class="${"pl-5 pt-5"}"><input type="${"number"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", changed_awsIoT_core_data.config.cloud_awsIoTcore_profile[modify_index].keepAliveInterval, 0)}></td><td><p class="${"pl-2 pt-4 text-lg"}">second(s)</p></td></tr>
...
<tr><td><p class="${"pl-20 pt-4 text-lg font-light text-right"}">Broker CA Certificate</p></td>
    <td class="${"pl-4 pt-4"}">${NewItem[new_item_index].tls == 0 ? `None` : `${NewItem[new_item_index].tls == 1 ? `<select class="${"block text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 text-sm p-2.5 mt-2 mb-4 w-48"}"><option disabled="${""}" value="${"none"}">Choose Certificate ...</option>${``}</select>` : ``}`}</td></tr>
