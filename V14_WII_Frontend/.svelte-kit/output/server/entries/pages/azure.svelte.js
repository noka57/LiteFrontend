...
import { azureConfig, AzHub_ConfigChangedLog, AzHubDPS_ConfigChangedLog, AzCentral_ConfigChangedLog, ChangedAzureConfig } from "../endpoints/configG.js";
...
const azure_svelte_svelte_type_style_lang = "";
const css = {
...
<table><tr><td><p class="${"pl-20 pt-4 text-lg font-light text-right"}">Hub Name</p></td><td class="${"pl-5 pt-5"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", changed_azure_data.config.cloud_azHub_profile[modify_index].azHubName, 0)}></td>
...
<table><tr><td><p class="${"pl-20 pt-4 text-lg font-light text-right"}">Hub Name</p></td><td class="${"pl-5 pt-5"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", NewItem[new_item_index].azHubName, 0)}></td>
    <td class="${"w-10"}"></td>
    <td class="${"w-10"}"></td>
    <td class="${"w-10"}"></td>
    <td class="${"w-10"}"></td>
...
${NewItem[new_item_index].attestation == 0 ? `<tr><td><p class="${"pl-20 pt-4 text-lg font-light text-right"}">Symmetric Key</p></td><td class="${"pl-5 pt-5"}" colspan="${"6"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", NewItem[new_item_index].symmetric_key_primary, 0)}></td></tr>` : `${NewItem[new_item_index].attestation == 1 ? `<tr><td><p class="${"pl-20 pt-4 text-lg font-light text-right"}">Machine CA Certificate</p></td>
      <td class="${"pl-5 pt-5"}" colspan="${"2"}"><select class="${"block text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 text-sm p-2.5 mt-2 mb-4 w-48"}"><option disabled="${""}" value="${"none"}">Choose Certificate ...</option>${``}</select></td></tr>
