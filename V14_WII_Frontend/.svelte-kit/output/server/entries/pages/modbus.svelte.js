...
<td></td></tr>
  ...
  <tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Response Timeout</p></td><td class="${"pl-5 pt-5 w-18"}" colspan="${"2"}"><div class="${"flex gap-2"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-18 p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", new_data_model_master[new_data_model_master_index].responseTimeout, 0)}><p class="${"pl-1 pt-4"}">ms</p></div></td>

<td></td>
<td></td>
<td></td></tr>

  <tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Polling Rate</p></td><td class="${"pl-5 pt-5 w-18"}" colspan="${"2"}"><div class="${"flex gap-2"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-18 p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", new_data_model_master[new_data_model_master_index].pollingRate, 0)}><p class="${"pl-1 pt-4"}">ms</p></div></td>

<td></td>
<td></td>
<td></td></tr>

  <tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Delay Between Polls</p></td><td class="${"pl-5 pt-5 w-18"}" colspan="${"2"}"><div class="${"flex gap-2"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-18 p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", new_data_model_master[new_data_model_master_index].delayBetweenPolls, 0)}><p class="${"pl-1 pt-4"}">ms</p></div></td>
