...
import { sdataLoggerConfig, ChangedSDataLoggerConfig, genericMQTTConfig, GenericMQTTConfigChangedLog, ChangedGenericMQTTConfig, eventEngineConfig, ChangedEventEngineConfig, SDatalogger_ProxyMode_Cloud_ConfigChangedLog, SDatalogger_MonitorMode_Cloud_ConfigChangedLog, EventEngine_TriggerMQTT_ConfigChangedLog, EventEngine_ActionMQTT_ConfigChangedLog } from "../endpoints/configG.js";
...
const gMQTT_svelte_svelte_type_style_lang = "";
const css = {
...
<tr class="${"pt-4"}"><td><p class="${"pl-20 pt-4 text-lg font-light text-right"}">Retained</p></td>
    ...
    <td class="${"pl-4 pt-8"}"><div class="${"flex gap-2"}">${validate_component(Radio, "Radio").$$render(
                          $$result,
                          {
                            class: "pb-2",
                            value: 1,
                            group: changed_generic_mqtt_data.config.cloud_genericMqtt_profile[modify_index].retained
                          },
                          {
                            group: ($$value) => {
                              changed_generic_mqtt_data.config.cloud_genericMqtt_profile[modify_index].retained = $$value;
                              $$settled = false;
                            }
                          },
                          {
...
<tr><td><p class="${"pl-20 pt-4 text-lg font-light text-right"}">Data Compression</p></td>
 ...
 <tr><td><p class="${"pl-4 pt-4 text-lg font-light text-right"}">Data Push Interval</p></td>
      <td class="${"pl-5 pt-5"}"><div class="${"flex gap-4"}">${validate_component(Radio, "Radio").$$render($$result, { value: "Now" }, {}, {
                          default: () => {
                            return `Right Away`;
                          }
                        })}
  ${validate_component(Radio, "Radio").$$render($$result, { value: "UserDefine" }, {}, {
                          default: () => {
                            return `User Defined (mins): `;
                          }
                        })}
${`<input type="${"number"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-green-500 w-16"}">`}</div></td></tr>

<tr><td><p class="${"pl-4 pt-4 text-lg font-light text-right"}">Link Lost Retransmit</p></td>
    <td class="${"pl-4 pt-4"}"><div class="${"flex gap-4"}"><input type="${"number"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-16 p-2.5 dark:bg-gray-700 dark:border-green-500"}">
...
<tr><td><p class="${"pl-4 pt-4 text-lg font-light text-right"}">Data Priority</p></td>
      <td class="${"pl-4 pt-4"}"><div class="${"flex gap-4"}">${validate_component(Radio, "Radio").$$render($$result, { value: "Latest" }, {}, {
                          default: () => {
                            return `Latest First`;
                          }
                        })}
  ${validate_component(Radio, "Radio").$$render($$result, { value: "FIFO" }, {}, {
                          default: () => {
