...
const modbus_svelte_svelte_type_style_lang = "";
const css = {
...
${validate_component(TabItem, "TabItem").$$render($$result, { title: "Tag" }, {}, {
  ...
  ${validate_component(TableBody, "TableBody").$$render($$result, {}, {}, {
     ...
     ${validate_component(TableBodyRow, "TableBodyRow").$$render($$result, {}, {}, {
                        default: () => {
                          return `${changed_modbus_data.config.fieldManagement_modbus_tag.length < 10 ? `${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, { class: "!p-4 w-10" }, {}, {
                            default: () => {
                              return `<button><svg aria-hidden="${"true"}" fill="${"none"}" stroke="${"currentColor"}" stroke-width="${"1.5"}" viewBox="${"0 0 24 24"}" xmlns="${"http://www.w3.org/2000/svg"}" class="${"text-gray-500 ml-2 dark:text-pink-500 w-6 h-6"}"><path d="${"M12 4V20M20 12L4 12"}" stroke-width="${"2"}" stroke-linecap="${"round"}" stroke-linejoin="${"round"}"></path></svg></button>`;
                            }
                          })}` : `${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, { class: "!p-4 w-16" }, {}, {})}`}
...
${new_tag[new_tag_index].masterProfile[0] == "R" ? `<tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Slave ID</p></td><td class="${"pl-5 pt-5"}"><input type="${"number"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-20 p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", new_tag[new_tag_index].slaveId, 0)}></td>
<td></td>
<td></td>
...
${new_tag[new_tag_index].masterProfile[0] == "T" ? `<tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Polling Rate</p></td><td class="${"pl-5 pt-5 w-18"}" colspan="${"2"}"><div class="${"flex gap-2"}"><input type="${"number"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-20 p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", new_tag[new_tag_index].pollingRate, 0)}><p class="${"pl-1 pt-4"}">ms</p></div></td>
...
<td></td></tr>`}  
    ...
    ${validate_component(TabItem, "TabItem").$$render($$result, { title: "Data Model" }, {}, {
          default: () => {
            return `${validate_component(Accordion, "Accordion").$$render($$result, {}, {}, {
              default: () => {
                return `${validate_component(AccordionItem, "AccordionItem").$$render($$result, { defaultClass }, {}, {
  ...
  ${validate_component(TableBody, "TableBody").$$render($$result, {}, {}, {
     ...
     ${validate_component(TableBodyRow, "TableBodyRow").$$render($$result, {}, {}, {
                                default: () => {
                                  return `${changed_modbus_data.config.fieldManagement_modbus_data_model.master.length < 10 ? `${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, { class: "!p-4 w-10" }, {}, {
                                    default: () => {
                                      return `<button><svg aria-hidden="${"true"}" fill="${"none"}" stroke="${"currentColor"}" stroke-width="${"1.5"}" viewBox="${"0 0 24 24"}" xmlns="${"http://www.w3.org/2000/svg"}" class="${"text-gray-500 ml-2 dark:text-pink-500 w-6 h-6"}"><path d="${"M12 4V20M20 12L4 12"}" stroke-width="${"2"}" stroke-linecap="${"round"}" stroke-linejoin="${"round"}"></path></svg></button>`;
                                    }
                                  })}` : `${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, { class: "!p-4 w-16" }, {}, {})}`}
     ...
     ${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, { class: "!p-0 w-10" }, {}, {})}
      ${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, {}, {}, {})}
      ${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, { class: "!p-1 w-4" }, {}, {})}
      ${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, { class: "!p-4 w-18" }, {}, {})}
      ${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, { class: "w-10" }, {}, {})}
  ...
  ${validate_component(Modal, "Modal").$$render(
                            $$result,
                            {
                              ...
                              class: "w-full",
                              autoclose: true,
                              open: new_data_model_master_modal
                            },
                            {
                              open: ($$value) => {
                                new_data_model_master_modal = $$value;
                                $$settled = false;
                              }
                            },
                            {
...
<table><tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Data Model Name</p></td>
      <td class="${"pl-5 pt-5"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", new_data_model_master[new_data_model_master_index].dataModelName, 0)}></td></tr>
...
<tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Slave ID</p></td><td class="${"pl-5 pt-5"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", new_data_model_master[new_data_model_master_index].slaveId, 0)}></td>
<td></td>
<td></td>
<td></td></tr>
...
<tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Point Type</p></td>
    ...
    <td class="${"pl-4 pt-4"}" colspan="${"5"}"><div class="${"flex gap-4"}">${validate_component(Radio, "Radio").$$render(
                                  ...
                                  {
                                    value: 0,
                                    group: new_data_model_master[new_data_model_master_index].pointType
                                  },
                                  {
                                    group: ($$value) => {
                                      new_data_model_master[new_data_model_master_index].pointType = $$value;
                                      $$settled = false;
                                    }
                                  },
                                  {
...
<tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Address</p></td><td class="${"pl-5 pt-5"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", new_data_model_master[new_data_model_master_index].address, 0)}></td>
...
<td></td></tr>
  ...
  <tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Quantity</p></td><td class="${"pl-5 pt-5"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", new_data_model_master[new_data_model_master_index].quantity, 0)}></td>
...
<td></td></tr>
  ...
  <tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Byte Order</p></td>
    ...
    <td class="${"pl-4 pt-5"}" colspan="${"5"}"><div class="${"flex gap-2"}">${validate_component(Radio, "Radio").$$render(
                                  ...
                                  {
                                    value: 0,
                                    group: new_data_model_master[new_data_model_master_index].byteOrder
                                  },
                                  {
                                    group: ($$value) => {
                                      new_data_model_master[new_data_model_master_index].byteOrder = $$value;
                                      $$settled = false;
                                    }
                                  },
                                  {
  ...
  <tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Response Timeout</p></td><td class="${"pl-5 pt-5 w-18"}" colspan="${"2"}"><div class="${"flex gap-2"}"><input type="${"number"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-18 p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", new_data_model_master[new_data_model_master_index].responseTimeout, 0)}><p class="${"pl-1 pt-4"}">ms</p></div></td>

<td></td>
<td></td>
<td></td></tr>

  <tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Polling Rate</p></td><td class="${"pl-5 pt-5 w-18"}" colspan="${"2"}"><div class="${"flex gap-2"}"><input type="${"number"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-18 p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", new_data_model_master[new_data_model_master_index].pollingRate, 0)}><p class="${"pl-1 pt-4"}">ms</p></div></td>

<td></td>
<td></td>
<td></td></tr>

  <tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Delay Between Polls</p></td><td class="${"pl-5 pt-5 w-18"}" colspan="${"2"}"><div class="${"flex gap-2"}"><input type="${"number"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-18 p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", new_data_model_master[new_data_model_master_index].delayBetweenPolls, 0)}><p class="${"pl-1 pt-4"}">ms</p></div></td>
...
${validate_component(Modal, "Modal").$$render(
                            $$result,
                            {
                              ...
                              class: "w-full",
                              permanent: true,
                              open: Modify_Data_Model_Master_Modal
                            },
                            {
                              open: ($$value) => {
                                Modify_Data_Model_Master_Modal = $$value;
                                $$settled = false;
                              }
                            },
                            {
...
<p class="${"mt-10"}"></p>
<table><tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Data Model Name</p></td>
      <td class="${"pl-5 pt-5"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", changed_modbus_data.config.fieldManagement_modbus_data_model.master[Modify_Data_Model_Master_index].dataModelName, 0)}></td></tr>
...
<tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Slave ID</p></td><td class="${"pl-5 pt-5"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", changed_modbus_data.config.fieldManagement_modbus_data_model.master[Modify_Data_Model_Master_index].slaveId, 0)}></td>
<td></td>
<td></td>
<td></td></tr>
...
<tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Point Type</p></td>
    ...
    <td class="${"pl-4 pt-4"}" colspan="${"5"}"><div class="${"flex gap-4"}">${validate_component(Radio, "Radio").$$render(
                                  ...
                                  {
                                    value: 0,
                                    group: changed_modbus_data.config.fieldManagement_modbus_data_model.master[Modify_Data_Model_Master_index].pointType
                                  },
                                  {
                                    group: ($$value) => {
                                      changed_modbus_data.config.fieldManagement_modbus_data_model.master[Modify_Data_Model_Master_index].pointType = $$value;
                                      $$settled = false;
                                    }
                                  },
                                  {
...
<tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Address</p></td><td class="${"pl-5 pt-5"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", changed_modbus_data.config.fieldManagement_modbus_data_model.master[Modify_Data_Model_Master_index].address, 0)}></td>
...
<td></td></tr>
  ...
  <tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Quantity</p></td><td class="${"pl-5 pt-5"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", changed_modbus_data.config.fieldManagement_modbus_data_model.master[Modify_Data_Model_Master_index].quantity, 0)}></td>
...
<td></td></tr>
  ...
  <tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Byte Order</p></td>
    ...
    <td class="${"pl-4 pt-5"}" colspan="${"5"}"><div class="${"flex gap-2"}">${validate_component(Radio, "Radio").$$render(
                                  ...
                                  {
                                    value: 0,
                                    group: changed_modbus_data.config.fieldManagement_modbus_data_model.master[Modify_Data_Model_Master_index].byteOrder
                                  },
                                  {
                                    group: ($$value) => {
                                      changed_modbus_data.config.fieldManagement_modbus_data_model.master[Modify_Data_Model_Master_index].byteOrder = $$value;
                                      $$settled = false;
                                    }
                                  },
                                  {
  ...
  <tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Response Timeout</p></td><td class="${"pl-5 pt-5 w-18"}" colspan="${"2"}"><div class="${"flex gap-2"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-18 p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", changed_modbus_data.config.fieldManagement_modbus_data_model.master[Modify_Data_Model_Master_index].responseTimeout, 0)}><p class="${"pl-1 pt-4"}">ms</p></div></td>

<td></td>
<td></td>
<td></td></tr>

  <tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Polling Rate</p></td><td class="${"pl-5 pt-5 w-18"}" colspan="${"2"}"><div class="${"flex gap-2"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-18 p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", changed_modbus_data.config.fieldManagement_modbus_data_model.master[Modify_Data_Model_Master_index].pollingRate, 0)}><p class="${"pl-1 pt-4"}">ms</p></div></td>

<td></td>
<td></td>
<td></td></tr>

  <tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Delay Between Polls</p></td><td class="${"pl-5 pt-5 w-18"}" colspan="${"2"}"><div class="${"flex gap-2"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-18 p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", changed_modbus_data.config.fieldManagement_modbus_data_model.master[Modify_Data_Model_Master_index].delayBetweenPolls, 0)}><p class="${"pl-1 pt-4"}">ms</p></div></td>
...
<td></td></tr>
  ...
  ${validate_component(TableBody, "TableBody").$$render($$result, {}, {}, {
     ...
     ${validate_component(TableBodyRow, "TableBodyRow").$$render($$result, {}, {}, {
                              default: () => {
                                return `${changed_modbus_data.config.fieldManagement_modbus_data_model.slave.length < 10 ? `${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, { class: "!p-4 w-10" }, {}, {
                                  default: () => {
                                    return `<button><svg aria-hidden="${"true"}" fill="${"none"}" stroke="${"currentColor"}" stroke-width="${"1.5"}" viewBox="${"0 0 24 24"}" xmlns="${"http://www.w3.org/2000/svg"}" class="${"text-gray-500 ml-2 dark:text-pink-500 w-6 h-6"}"><path d="${"M12 4V20M20 12L4 12"}" stroke-width="${"2"}" stroke-linecap="${"round"}" stroke-linejoin="${"round"}"></path></svg></button>`;
                                  }
                                })}` : `${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, { class: "!p-4 w-16" }, {}, {})}`}     
  ...
  ${validate_component(Modal, "Modal").$$render(
                          $$result,
                          {
                            ...
                            class: "w-full",
                            autoclose: true,
                            open: new_data_model_slave_modal
                          },
                          {
                            open: ($$value) => {
                              new_data_model_slave_modal = $$value;
                              $$settled = false;
                            }
                          },
                          {
...
<table><tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Data Model Name</p></td>
      <td class="${"pl-5 pt-5"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", new_data_model_slave[new_data_model_slave_index].dataModelName, 0)}></td></tr>
...
<tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Slave ID</p></td><td class="${"pl-5 pt-5"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", new_data_model_slave[new_data_model_slave_index].slaveId, 0)}></td>
<td></td>
<td></td>
<td></td></tr>
...
<tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Point Type</p></td>
    ...
    <td class="${"pl-4 pt-4"}" colspan="${"5"}"><div class="${"flex gap-4"}">${validate_component(Radio, "Radio").$$render(
                                ...
                                {
                                  value: 0,
                                  group: new_data_model_slave[new_data_model_slave_index].pointType
                                },
                                {
                                  group: ($$value) => {
                                    new_data_model_slave[new_data_model_slave_index].pointType = $$value;
                                    $$settled = false;
                                  }
                                },
                                {
...
<tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Address</p></td><td class="${"pl-5 pt-5"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", new_data_model_slave[new_data_model_slave_index].address, 0)}></td>
...
<td></td></tr>
  ...
  <tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Quantity</p></td><td class="${"pl-5 pt-5"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", new_data_model_slave[new_data_model_slave_index].quantity, 0)}></td>
...
<td></td></tr>
  ...
  <tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Byte Order</p></td>
    ...
    <td class="${"pl-4 pt-5"}" colspan="${"5"}"><div class="${"flex gap-2"}">${validate_component(Radio, "Radio").$$render(
                                ...
                                {
                                  value: 0,
                                  group: new_data_model_slave[new_data_model_slave_index].byteOrder
                                },
                                {
                                  group: ($$value) => {
                                    new_data_model_slave[new_data_model_slave_index].byteOrder = $$value;
                                    $$settled = false;
                                  }
                                },
                                {
...
${validate_component(Modal, "Modal").$$render(
                          $$result,
                          {
                            ...
                            class: "w-full",
                            permanent: true,
                            open: Modify_Data_Model_Slave_Modal
                          },
                          {
                            open: ($$value) => {
                              Modify_Data_Model_Slave_Modal = $$value;
                              $$settled = false;
                            }
                          },
                          {
...
<p class="${"mt-10"}"></p>
<table><tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Data Model Name</p></td>
      <td class="${"pl-5 pt-5"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", changed_modbus_data.config.fieldManagement_modbus_data_model.slave[Modify_Data_Model_Slave_index].dataModelName, 0)}></td></tr>
...
<tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Slave ID</p></td><td class="${"pl-5 pt-5"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", changed_modbus_data.config.fieldManagement_modbus_data_model.slave[Modify_Data_Model_Slave_index].slaveId, 0)}></td>
<td></td>
<td></td>
<td></td></tr>
...
<tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Point Type</p></td>
    ...
    <td class="${"pl-4 pt-4"}" colspan="${"5"}"><div class="${"flex gap-4"}">${validate_component(Radio, "Radio").$$render(
                                ...
                                {
                                  value: 0,
                                  group: changed_modbus_data.config.fieldManagement_modbus_data_model.slave[Modify_Data_Model_Slave_index].pointType
                                },
                                {
                                  group: ($$value) => {
                                    changed_modbus_data.config.fieldManagement_modbus_data_model.slave[Modify_Data_Model_Slave_index].pointType = $$value;
                                    $$settled = false;
                                  }
                                },
                                {
...
<tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Address</p></td><td class="${"pl-5 pt-5"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", changed_modbus_data.config.fieldManagement_modbus_data_model.slave[Modify_Data_Model_Slave_index].address, 0)}></td>
...
<td></td></tr>
  ...
  <tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Quantity</p></td><td class="${"pl-5 pt-5"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", changed_modbus_data.config.fieldManagement_modbus_data_model.slave[Modify_Data_Model_Slave_index].quantity, 0)}></td>
...
<td></td></tr>
  ...
  <tr><td><p class="${"pl-2 pt-4 text-lg font-light text-right"}">Byte Order</p></td>
    ...
    <td class="${"pl-4 pt-5"}" colspan="${"5"}"><div class="${"flex gap-2"}">${validate_component(Radio, "Radio").$$render(
                                ...
                                {
                                  value: 0,
                                  group: changed_modbus_data.config.fieldManagement_modbus_data_model.slave[Modify_Data_Model_Slave_index].byteOrder
                                },
                                {
                                  group: ($$value) => {
                                    changed_modbus_data.config.fieldManagement_modbus_data_model.slave[Modify_Data_Model_Slave_index].byteOrder = $$value;
                                    $$settled = false;
                                  }
                                },
                                {
