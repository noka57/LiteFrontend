<script>
  ...
  //  console.log(changed_generic_mqtt_data.config.cloud_genericMqtt_profile);
    ...
    for (let i=0; i < Math.min(changed_generic_mqtt_data.config.cloud_genericMqtt_profile.length, saved_changed_generic_mqtt_data.config.cloud_genericMqtt_profile.length); i++) 
    {
      ...
      for (let j=0; j < saved_changed_remote_service_data.config.service_remoteService.mqtt_api_param.length;j++)
      {
        if (saved_changed_remote_service_data.config.service_remoteService.mqtt_api_param[j].cloudProfile == item)
        {
          if (!changed_generic_mqtt_data.config.cloud_genericMqtt_profile[i].delete&&(changed_generic_mqtt_data.config.cloud_genericMqtt_profile[i].brokerHost != saved_changed_generic_mqtt_data.config.cloud_genericMqtt_profile[i].brokerHost ||
          changed_generic_mqtt_data.config.cloud_genericMqtt_profile[i].brokerPort != saved_changed_generic_mqtt_data.config.cloud_genericMqtt_profile[i].brokerPort))
          {
            ...
            saved_changed_remote_service_data.config.service_remoteService.mqtt_api_param[j].cloudProfile=new_item;

            let changedstr="List No." +(j+1) +" item is changed: value of cloudProfile is changed to "+ new_item;
          ...
          if (!saved_changed_generic_mqtt_data.config.cloud_genericMqtt_profile[i].delete && changed_generic_mqtt_data.config.cloud_genericMqtt_profile[i].delete)
          {
            let changedstr="List No." +(j+1) +" item is changed: value of cloudProfile is is deleted";
            remote_service_mqtt_changedValues=[...remote_service_mqtt_changedValues, changedstr];

            saved_changed_remote_service_data.config.service_remoteService.mqtt_api_param[j].cloudProfile="";
            RemoteServiceConfigMqttChangedLog.set(remote_service_mqtt_changedValues);
            ChangedRemoteServiceConfig.set(saved_changed_remote_service_data);
      ...
      for (let j=0; j < saved_changed_remote_service_data.config.service_remoteService.remote_control_param.length;j++)
      {
        if (saved_changed_remote_service_data.config.service_remoteService.remote_control_param[j].cloudProfile == item)
        {
          if (!changed_generic_mqtt_data.config.cloud_genericMqtt_profile[i].delete&&(changed_generic_mqtt_data.config.cloud_genericMqtt_profile[i].brokerHost != saved_changed_generic_mqtt_data.config.cloud_genericMqtt_profile[i].brokerHost ||
          changed_generic_mqtt_data.config.cloud_genericMqtt_profile[i].brokerPort != saved_changed_generic_mqtt_data.config.cloud_genericMqtt_profile[i].brokerPort))
          {
            ...
            saved_changed_remote_service_data.config.service_remoteService.remote_control_param[j].cloudProfile=new_item;
          ...
          if (!saved_changed_generic_mqtt_data.config.cloud_genericMqtt_profile[i].delete && changed_generic_mqtt_data.config.cloud_genericMqtt_profile[i].delete)
          {
            ...
            saved_changed_remote_service_data.config.service_remoteService.remote_control_param[j].cloudProfile="";
            RemoteServiceConfigRemoteControlChangedLog.set(remote_service_remote_control_changedValues);
            ChangedRemoteServiceConfig.set(saved_changed_remote_service_data);
      ...
      if (data_tag_pro_flag==1)
      {
        ...
        for (let j=0; j < saved_changed_data_tag_pro_data.config.service_dataTagPro_tagRule.cloud2DeviceTag.length;j++)
        {
          if (saved_changed_data_tag_pro_data.config.service_dataTagPro_tagRule.cloud2DeviceTag[j].cloudProfile == item)
          {
            if (!changed_generic_mqtt_data.config.cloud_genericMqtt_profile[i].delete&&(changed_generic_mqtt_data.config.cloud_genericMqtt_profile[i].brokerHost != saved_changed_generic_mqtt_data.config.cloud_genericMqtt_profile[i].brokerHost ||
            changed_generic_mqtt_data.config.cloud_genericMqtt_profile[i].brokerPort != saved_changed_generic_mqtt_data.config.cloud_genericMqtt_profile[i].brokerPort))
            {
              ...
              saved_changed_data_tag_pro_data.config.service_dataTagPro_tagRule.cloud2DeviceTag[j].cloudProfile=new_item;
            ...
            if (!saved_changed_generic_mqtt_data.config.cloud_genericMqtt_profile[i].delete && changed_generic_mqtt_data.config.cloud_genericMqtt_profile[i].delete)
            {
              ...
              saved_changed_data_tag_pro_data.config.service_dataTagPro_tagRule.cloud2DeviceTag[j].cloudProfile="";
              DataTagPro_TagRuleC2D_ConfigChangedLog.set(data_tag_pro_tag_c2d_changedValues);
              ChangedDataTagProConfig.set(saved_changed_data_tag_pro_data);
        ...
        for (let j=0; j < saved_changed_data_tag_pro_data.config.service_dataTagPro_ulRule.length;j++)
        {
          for (let k=0; k < saved_changed_data_tag_pro_data.config.service_dataTagPro_ulRule[j].cloud.length;k++)
          {
            if (saved_changed_data_tag_pro_data.config.service_dataTagPro_ulRule[j].cloud[k].profile == item)
            {
              if (!changed_generic_mqtt_data.config.cloud_genericMqtt_profile[i].delete&&(changed_generic_mqtt_data.config.cloud_genericMqtt_profile[i].brokerHost != saved_changed_generic_mqtt_data.config.cloud_genericMqtt_profile[i].brokerHost ||
              changed_generic_mqtt_data.config.cloud_genericMqtt_profile[i].brokerPort != saved_changed_generic_mqtt_data.config.cloud_genericMqtt_profile[i].brokerPort))
              {
                ...
                saved_changed_data_tag_pro_data.config.service_dataTagPro_ulRule[j].cloud[k].profile=new_item;

                let changedstr="List No." +(j+1) +" item is changed: value of cloud No. " + (k+1)+ " profile is changed to "+ new_item;
              ...
              if (!saved_changed_generic_mqtt_data.config.cloud_genericMqtt_profile[i].delete && changed_generic_mqtt_data.config.cloud_genericMqtt_profile[i].delete)
              {
                let changedstr="List No." +(j+1) +" item is changed: value of cloud No. " + (k+1)+ " profile is deleted";
                data_tag_pro_ul_changedValues=[...data_tag_pro_ul_changedValues, changedstr];

                saved_changed_data_tag_pro_data.config.service_dataTagPro_ulRule[j].cloud[k].profile="";
                DataTagPro_ULRule_ConfigChangedLog.set(data_tag_pro_ul_changedValues);
                ChangedDataTagProConfig.set(saved_changed_data_tag_pro_data);
 ...
 async function getDataTagPro () {
    ...
    if (res.status == 200)
    {
      console.log("gMQTT get data tag pro")
  ...
  async function getGenericMQTTData () {
    ...
    if (res.status == 200)
    {
      ...
      if (saved_changed_remote_service_data=="")
      {
