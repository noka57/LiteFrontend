<script>
  ...
  function TriggerModifyCOM(index)
  {
    ...
    backup_com_profile.usedby=changed_port_connection_data.config.fieldManagement_portConnection_com[index].usedby;
    backup_com_profile.role=changed_port_connection_data.config.fieldManagement_portConnection_com[index].role;
  }
  ...
  function NoModifyCOM(index)
  {
    ...
    changed_port_connection_data.config.fieldManagement_portConnection_com[index].usedby=backup_com_profile.usedby;
    changed_port_connection_data.config.fieldManagement_portConnection_com[index].role=backup_com_profile.role;
  }
  ...
  function saveCom()
  {
    ...
    for (let i=0;i<changed_port_connection_data.config.fieldManagement_portConnection_com.length;i++)
    {
        ...
        if (port_connection_data.config.fieldManagement_portConnection_com[i].usedby != changed_port_connection_data.config.fieldManagement_portConnection_com[i].usedby)
        {
            saved_changed_port_connection_data.config.fieldManagement_portConnection_com[i].usedby=changed_port_connection_data.config.fieldManagement_portConnection_com[i].usedby;
            let changedstr="COM List No."+(i+1)+" usedby is changed to "+changed_port_connection_data.config.fieldManagement_portConnection_com[i].usedby;

            port_connection_com_changedValues=[...port_connection_com_changedValues, changedstr];            
        }

        if (port_connection_data.config.fieldManagement_portConnection_com[i].role != changed_port_connection_data.config.fieldManagement_portConnection_com[i].role)
        {
            saved_changed_port_connection_data.config.fieldManagement_portConnection_com[i].role=changed_port_connection_data.config.fieldManagement_portConnection_com[i].role;
            let changedstr="COM List No."+(i+1)+" role is changed to "+changed_port_connection_data.config.fieldManagement_portConnection_com[i].role;
...
<TableHead>    
  <TableHeadCell class="!p-4">
    ...
    <TableHeadCell class="w-18">Used By</TableHeadCell>   
    <TableHeadCell class="w-18">Role</TableHeadCell>        
  </TableHead>
  <TableBody>
...
{#if ComItem.usedby ==0}
      <TableBodyCell class="w-18">Transparent</TableBodyCell>
{:else if ComItem.usedby ==1}
      <TableBodyCell class="w-18">Modbus</TableBodyCell>
{:else if ComItem.usedby ==2}
      <TableBodyCell class="w-18">DNP3</TableBodyCell>
{/if}
...
{:else if ComItem.usedby ==1}
      {#if ComItem.role == 0}
      <TableBodyCell class="w-18">Master</TableBodyCell>
      {:else if ComItem.role ==1}
      <TableBodyCell class="w-18">Slave</TableBodyCell>
      {/if}
...
{:else if ComItem.usedby ==2}
      ...
      <TableBodyCell class="w-18">Master</TableBodyCell>
      {:else if ComItem.role ==1}
      <TableBodyCell class="w-18">Outstation</TableBodyCell>
      {/if}
{/if}
...
<tr>
      <td><p class="pl-4 pt-4 text-lg font-light text-right">Used By</p></td>


    <td class="pl-5 pt-4"><div class="flex gap-4">
  <Radio bind:group={changed_port_connection_data.config.fieldManagement_portConnection_com[modify_com_index].usedby} value={0} >Transparent</Radio>
  <Radio bind:group={changed_port_connection_data.config.fieldManagement_portConnection_com[modify_com_index].usedby} value={1} >Modbus</Radio>
  <Radio bind:group={changed_port_connection_data.config.fieldManagement_portConnection_com[modify_com_index].usedby} value={2} >DNP3</Radio>
</div></td>
...
<tr>
      <td><p class="pl-4 pt-4 text-lg font-light text-right">Role</p></td>


    <td class="pl-5 pt-4"><div class="flex gap-4">
{#if changed_port_connection_data.config.fieldManagement_portConnection_com[modify_com_index].usedby==0}    
    None
{:else if changed_port_connection_data.config.fieldManagement_portConnection_com[modify_com_index].usedby==1}
  <Radio bind:group={changed_port_connection_data.config.fieldManagement_portConnection_com[modify_com_index].role} value={0} >Master</Radio>
  <Radio bind:group={changed_port_connection_data.config.fieldManagement_portConnection_com[modify_com_index].role} value={1} >Slave</Radio>
{:else if changed_port_connection_data.config.fieldManagement_portConnection_com[modify_com_index].usedby==2}
  <Radio bind:group={changed_port_connection_data.config.fieldManagement_portConnection_com[modify_com_index].role} value={0} >Master</Radio>
  <Radio bind:group={changed_port_connection_data.config.fieldManagement_portConnection_com[modify_com_index].role} value={1} >Outstation</Radio>
{/if}
