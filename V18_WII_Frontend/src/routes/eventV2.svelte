...
,
  ...
  function new_rule_trigger(index)
  {
    ...
    NewRuleItem[index].repeatCnt=3;
    NewRuleItem[index].repeatInterval=10;
...
,
  ...
  function TriggerModifyActionModbus(index)
  {
    ...
    BackupActionModbus.modbusTagType=changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[index].modbusTagType;
    BackupActionModbus.modbusTagOwner=changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[index].modbusTagOwner;
    BackupActionModbus.modbusTagOwnerIndex=changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[index].modbusTagOwnerIndex;
  ...
  function NoModifyActionModbus(index)
  {
    ...
    changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[index].modbusTagType=BackupActionModbus.modbusTagType;
    changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[index].modbusTagOwner=BackupActionModbus.modbusTagOwner;
    changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[index].modbusTagOwnerIndex=BackupActionModbus.modbusTagOwnerIndex;
  ...
  function new_action_modbus_trigger(index)
  {
    ...
    NewActionModbus[index].modbusTagType=-1;
    NewActionModbus[index].modbusTagOwner="";
    NewActionModbus[index].modbusTagOwnerIndex=-1;
  ...
  function handleActionModbusChange(type)
  {
    if (type ==0)
    {
      console.log(NewActionModbus[new_action_modbus_index].modbusTagOwner);
      NewActionModbus[new_action_modbus_index].modbusTagOwnerIndex=Number(NewActionModbus[new_action_modbus_index].modbusTagOwner.substring(3));
      if (NewActionModbus[new_action_modbus_index].modbusTagOwner.startsWith("TS"))
      {
          NewActionModbus[new_action_modbus_index].modbusTagType=2;
      }
      else if (NewActionModbus[new_action_modbus_index].modbusTagOwner.startsWith("TM"))
      {
          NewActionModbus[new_action_modbus_index].modbusTagType=0;   
      }
      else if (NewActionModbus[new_action_modbus_index].modbusTagOwner.startsWith("RM"))
      {
          NewActionModbus[new_action_modbus_index].modbusTagType=1;   
      }

      console.log(NewActionModbus[new_action_modbus_index].modbusTagType);
      console.log(NewActionModbus[new_action_modbus_index].modbusTagOwnerIndex); 
    }
    else if (type ==1)
    {
      console.log(changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagOwner);
      changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagOwnerIndex=Number(changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagOwner.substring(3));

      if (changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagOwner.startsWith("TS"))
      {
          changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagType=2;
      }
      else if (changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagOwner.startsWith("TM"))
      {
          changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagType=0;   
      }
      else if (changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagOwner.startsWith("RM"))
      {
          changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagType=1;   
      }

      console.log(changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagType);
      console.log(changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagOwnerIndex); 
...
,
  ...
  function TriggerModifyModbus(index)
  {
    ...
    BackupTriggerModbus.modbusTagType=changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[index].modbusTagType;

    BackupTriggerModbus.modbusTagOwner=changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[index].modbusTagOwner;

    BackupTriggerModbus.modbusTagOwnerIndex=changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[index].modbusTagOwnerIndex;        
  ...
  function NoModifyTriggerModbus(index)
  {
    ...
    changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[index].modbusTagType=BackupTriggerModbus.modbusTagType;

    changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[index].modbusTagOwner=BackupTriggerModbus.modbusTagOwner;

    changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[index].modbusTagOwnerIndex=BackupTriggerModbus.modbusTagOwnerIndex;
  ...
  function new_trigger_modbus_trigger(index)
  {
      ...
      NewTriggerModbus[index].modbusTagType=-1;
      NewTriggerModbus[index].modbusTagOwner="";
      NewTriggerModbus[index].modbusTagOwnerIndex=-1;
  ...
  function NoAddModbusTrigger()
  {
      new_trigger_modbus_modal=false;
  }

  function handleTriggerModbusChange(type)
  {
    if (type ==0)
    {
      console.log(NewTriggerModbus[new_trigger_modbus_index].modbusTagOwner);
      NewTriggerModbus[new_trigger_modbus_index].modbusTagOwnerIndex=Number(NewTriggerModbus[new_trigger_modbus_index].modbusTagOwner.substring(3));
      if (NewTriggerModbus[new_trigger_modbus_index].modbusTagOwner.startsWith("TS"))
      {
          NewTriggerModbus[new_trigger_modbus_index].modbusTagType=2;
      }
      else if (NewTriggerModbus[new_trigger_modbus_index].modbusTagOwner.startsWith("TM"))
      {
          NewTriggerModbus[new_trigger_modbus_index].modbusTagType=0;   
      }
      else if (NewTriggerModbus[new_trigger_modbus_index].modbusTagOwner.startsWith("RM"))
      {
          NewTriggerModbus[new_trigger_modbus_index].modbusTagType=1;   
      }

      console.log(NewTriggerModbus[new_trigger_modbus_index].modbusTagType);
      console.log(NewTriggerModbus[new_trigger_modbus_index].modbusTagOwnerIndex); 
    }
    else if (type ==1)
    {
      console.log(changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagOwner);
      changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagOwnerIndex=Number(changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagOwner.substring(3));

      if (changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagOwner.startsWith("TS"))
      {
          changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagType=2;
      }
      else if (changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagOwner.startsWith("TM"))
      {
          changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagType=0;   
      }
      else if (changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagOwner.startsWith("RM"))
      {
          changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagType=1;   
      }

      console.log(changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagType);
      console.log(changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagOwnerIndex); 
...
<td class="px-6 py-4 whitespace-nowrap font-medium  text-gray-900 dark:text-white w-18 strikeout">{TriggerModbus.modbusTag} {#if TriggerModbus.modbusTagType==2} ({TCPSlaveTag[TriggerModbus.modbusTagOwnerIndex].modbusProfile}){:else if TriggerModbus.modbusTagType==0} ({TCPMasterTag[TriggerModbus.modbusTagOwnerIndex].modbusProfile}){:else if TriggerModbus.modbusTagType==1} ({RTUMasterTag[TriggerModbus.modbusTagOwnerIndex].modbusProfile}){/if}</td>
...
<input type="checkbox"  bind:checked={TriggerModbus.enable}>
      ...
      <TableBodyCell class="w-18">{TriggerModbus.modbusTag} {#if TriggerModbus.modbusTagType==2} ({TCPSlaveTag[TriggerModbus.modbusTagOwnerIndex].modbusProfile}){:else if TriggerModbus.modbusTagType==0} ({TCPMasterTag[TriggerModbus.modbusTagOwnerIndex].modbusProfile}){:else if TriggerModbus.modbusTagType==1} ({RTUMasterTag[TriggerModbus.modbusTagOwnerIndex].modbusProfile}){/if}</TableBodyCell>
...
{/if}
  ...
  <path d="M8 7H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-3m-1 4l-3 3m0 0l-3-3m3 3V4" stroke-linecap="round" stroke-linejoin="round"></path>
    ...
    <Modal bind:open={new_trigger_modbus_modal} size="lg" class="w-full" permanent={true}>
  <form action="#">
<label>
{#if getDataReady == 1}
...
<tr>
      <td><p class="pl-20 pt-2 text-lg font-light text-right">Modbus Tag</p></td>
    <td class= "pl-4 pt-4">
<div class="flex gap-4">
<select class="block text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 text-sm p-2.5 mt-2 mb-4 w-48" bind:value={NewTriggerModbus[new_trigger_modbus_index].modbusTagOwner} on:change={()=>handleTriggerModbusChange(0)}>
...
{#if NewTriggerModbus[new_trigger_modbus_index].modbusTagOwner != "" && NewTriggerModbus[new_trigger_modbus_index].modbusTagOwnerIndex != -1}

{#if NewTriggerModbus[new_trigger_modbus_index].modbusTagType==2 && NewTriggerModbus[new_trigger_modbus_index].modbusTagOwnerIndex < TCPSlaveTag.length}
{#each TCPSlaveTag[NewTriggerModbus[new_trigger_modbus_index].modbusTagOwnerIndex].tag as Tag, index}
<option value={Tag.tagName}>{Tag.tagName}</option>
{/each}

{:else if NewTriggerModbus[new_trigger_modbus_index].modbusTagType==0 && NewTriggerModbus[new_trigger_modbus_index].modbusTagOwnerIndex < TCPMasterTag.length}

{#each TCPMasterTag[NewTriggerModbus[new_trigger_modbus_index].modbusTagOwnerIndex].tag as Tag, index}
<option value={Tag.tagName}>{Tag.tagName}</option>
{/each}

{:else if NewTriggerModbus[new_trigger_modbus_index].modbusTagType==1 && NewTriggerModbus[new_trigger_modbus_index].modbusTagOwnerIndex < RTUMasterTag.length}
{#each RTUMasterTag[NewTriggerModbus[new_trigger_modbus_index].modbusTagOwnerIndex].tag as Tag, index}
<option value={Tag.tagName}>{Tag.tagName}</option>
{/each}
...
{#if changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagOwner != "" && changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagOwnerIndex != -1}

{#if changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagType==2 && changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagOwnerIndex < TCPSlaveTag.length}
{#each TCPSlaveTag[changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagOwnerIndex].tag as Tag, index}
<option value={Tag.tagName}>{Tag.tagName}</option>
{/each}

{:else if changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagType==0 && changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagOwnerIndex < TCPMasterTag.length}

{#each TCPMasterTag[changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagOwnerIndex].tag as Tag, index}
<option value={Tag.tagName}>{Tag.tagName}</option>
{/each}

{:else if changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagType==1 && changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagOwnerIndex < RTUMasterTag.length}
{#each RTUMasterTag[changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagOwnerIndex].tag as Tag, index}
<option value={Tag.tagName}>{Tag.tagName}</option>
{/each}
...
<td class="px-6 py-4 whitespace-nowrap font-medium  text-gray-900 dark:text-white w-18 strikeout">{Modbus.modbusTag} {#if Modbus.modbusTagType==2} ({TCPSlaveTag[Modbus.modbusTagOwnerIndex].modbusProfile}){:else if Modbus.modbusTagType==0} ({TCPMasterTag[Modbus.modbusTagOwnerIndex].modbusProfile}){:else if Modbus.modbusTagType==1} ({RTUMasterTag[Modbus.modbusTagOwnerIndex].modbusProfile}){/if}</td>
...
<input type="checkbox"  bind:checked={Modbus.enable}>
      ...
      <TableBodyCell class="w-18">{Modbus.modbusTag} {#if Modbus.modbusTagType==2} ({TCPSlaveTag[Modbus.modbusTagOwnerIndex].modbusProfile}){:else if Modbus.modbusTagType==0} ({TCPMasterTag[Modbus.modbusTagOwnerIndex].modbusProfile}){:else if Modbus.modbusTagType==1} ({RTUMasterTag[Modbus.modbusTagOwnerIndex].modbusProfile}){/if}</TableBodyCell>
...
<tr>
      <td><p class="pl-20 pt-3 text-lg font-light text-right">Modbus Tag</p></td>
    <td class= "pl-4 pt-5">
<div class="flex gap-4">
<select class="block text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 text-sm p-2.5 mt-2 mb-4 w-48" bind:value={NewActionModbus[new_action_modbus_index].modbusTagOwner} on:change={()=>handleActionModbusChange(0)}>
<option disabled="" value="">Choose ...</option>
...
{#if NewActionModbus[new_action_modbus_index].modbusTagOwner != "" && NewActionModbus[new_action_modbus_index].modbusTagOwnerIndex != -1}

{#if NewActionModbus[new_action_modbus_index].modbusTagType==2 && NewActionModbus[new_action_modbus_index].modbusTagOwnerIndex < TCPSlaveTag.length}
{#each TCPSlaveTag[NewActionModbus[new_action_modbus_index].modbusTagOwnerIndex].tag as Tag, index}
<option value={Tag.tagName}>{Tag.tagName}</option>
{/each}

{:else if NewActionModbus[new_action_modbus_index].modbusTagType==0 && NewActionModbus[new_action_modbus_index].modbusTagOwnerIndex < TCPMasterTag.length}

{#each TCPMasterTag[NewActionModbus[new_action_modbus_index].modbusTagOwnerIndex].tag as Tag, index}
<option value={Tag.tagName}>{Tag.tagName}</option>
{/each}

{:else if NewActionModbus[new_action_modbus_index].modbusTagType==1 && NewActionModbus[new_action_modbus_index].modbusTagOwnerIndex < RTUMasterTag.length}
{#each RTUMasterTag[NewActionModbus[new_action_modbus_index].modbusTagOwnerIndex].tag as Tag, index}
<option value={Tag.tagName}>{Tag.tagName}</option>
{/each}
...
<tr>
    ...
    <td class= "pl-4 pt-5">
<div class="flex gap-4">
<select class="block text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 text-sm p-2.5 mt-2 mb-4 w-48" bind:value={changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagOwner} on:change={()=>handleActionModbusChange(1)}>
<option disabled="" value="">Choose ...</option>
...
{#if changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagOwner != "" && changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagOwnerIndex != -1}

{#if changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagType==2 && changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagOwnerIndex < TCPSlaveTag.length}
{#each TCPSlaveTag[changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagOwnerIndex].tag as Tag, index}
<option value={Tag.tagName}>{Tag.tagName}</option>
{/each}

{:else if changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagType==0 && changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagOwnerIndex < TCPMasterTag.length}

{#each TCPMasterTag[changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagOwnerIndex].tag as Tag, index}
<option value={Tag.tagName}>{Tag.tagName}</option>
{/each}

{:else if changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagType==1 && changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagOwnerIndex < RTUMasterTag.length}
{#each RTUMasterTag[changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagOwnerIndex].tag as Tag, index}
<option value={Tag.tagName}>{Tag.tagName}</option>
{/each}
...
<td class="px-6 py-4 whitespace-nowrap font-medium text-gray-900 dark:text-white w-36 strikeout">
      {rule.delaySecond}-second delay to execute {#if rule.actionOption==0}once {:else if rule.actionOption==1}repeatedly{/if} the action: {#if rule.actionCatalog==0}SMS({rule.actionProfile}){:else if rule.actionCatalog==1}DO({rule.actionProfile}){:else if rule.actionCatalog==2}Modbus({rule.actionProfile}){:else if rule.actionCatalog==3}({rule.actionProfile}){:else if rule.actionCatalog==4}MQTT({rule.actionProfile}){:else if rule.actionCatalog==5}LINE({rule.actionProfile}){:else if rule.actionCatalog==7}System({#if rule.actionOperation==0}System Reboot{:else if rule.actionOperation==3}SW Reset C-WAN module{:else if rule.actionOperation==4}HW Reset C-WAN module{:else if rule.actionOperation==5}WAN Backup Switch{:else if rule.actionOperation==6}C-WAN Power Cycle{:else if rule.actionOperation==7}SIM Switch{:else if rule.actionOperation==8}Update Firmware{/if}){:else if rule.actionCatalog==8}MQTT API({#if rule.actionOperation==0}MQTT API Disable{:else if rule.actionOperation==1}MQTT API Enable{/if}){:else if rule.actionCatalog==9}REST API({#if rule.actionOperation==0}REST API Disable{:else if rule.actionOperation==1}REST API Enable{/if}){/if} {#if rule.actionOption==1} with a {rule.repeatInterval}-second interval.{/if}
...
<tr>
      <td><p class="pl-20 pt-4 text-lg font-light text-right">Repeat Interval</p></td><td class="pl-5 pt-5"><input type="number" bind:value={NewRuleItem[new_rule_index].repeatInterval} class="bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-18 dark:bg-gray-700 dark:border-green-500"></td><td class="pl-5 pt-5">Second(s)</td>
...
<option value={8}>Update Firmware</option>
</select>
...
<tr>
      <td><p class="pl-20 pt-4 text-lg font-light text-right">Repeat Interval</p></td><td class="pl-5 pt-5"><input type="number" bind:value={changed_event_engine_data.config.service_eventEngine_ruleSettings[modify_rule_index].repeatInterval} class="bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-18 dark:bg-gray-700 dark:border-green-500"></td><td class="pl-5 pt-5">Second(s)</td>
...
{:else if changed_event_engine_data.config.service_eventEngine_ruleSettings[modify_rule_index].actionCatalog == 8}
...
{:else if changed_event_engine_data.config.service_eventEngine_ruleSettings[modify_rule_index].actionCatalog == 9}
