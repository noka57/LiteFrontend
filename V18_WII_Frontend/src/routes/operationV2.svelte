...
<table>
 ...
 <tr>
  <td><p class="pl-5 pt-4 text-lg font-light text-right">Storage</p>
    ...
    {#if getDataReady == 1}
      <Radio bind:group={changed_operation_data.config.system_operation_storage} value={0} >Internal (100MB)</Radio>
      <Radio bind:group={changed_operation_data.config.system_operation_storage} value={1} >External SD Card</Radio>
    {/if}
</div></td>
</tr>
