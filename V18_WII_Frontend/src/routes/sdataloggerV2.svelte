...
<Dropdown simple>
{#each new_proxy_edge[new_proxy_edge_index].modbusTCPSlaveTag as Slave}
...
{#each new_proxy_edge[new_proxy_edge_index].modbusTCPMasterTag as TCPMaster}
...
{#each new_proxy_edge[new_proxy_edge_index].modbusRTUMasterTag as RTUMaster}
...
<Button>Choose Tag<ChevronDownOutline class="ms-2 h-6 w-6 text-white dark:text-white" /></Button>
<Dropdown simple>
{#each changed_sdata_logger_data.config.service_smartDataLogger_proxyMode.edgeData[modify_proxy_edge_index].modbusTCPSlaveTag as Slave}
...
{#each changed_sdata_logger_data.config.service_smartDataLogger_proxyMode.edgeData[modify_proxy_edge_index].modbusTCPMasterTag as TCPMaster}
...
{#each changed_sdata_logger_data.config.service_smartDataLogger_proxyMode.edgeData[modify_proxy_edge_index].modbusRTUMasterTag as RTUMaster}
