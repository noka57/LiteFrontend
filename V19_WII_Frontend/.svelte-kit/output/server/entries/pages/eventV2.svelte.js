import { c as create_ssr_component, k as subscribe, v as validate_component, i as add_attribute, o as each, e as escape } from "../../_app/immutable/chunks/index-581edbff.js";
...
import { F as FloatingLabelInput } from "../../_app/immutable/chunks/FloatingLabelInput-28f9dad1.js";
...
const EventV2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
...
<tr><td><p class="${"pl-20 pt-2 text-lg font-light text-right"}">Modbus Tag</p></td>
    <td class="${"pl-4 pt-4"}"><div class="${"flex gap-4"}"><select class="${"block text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 text-sm p-2.5 mt-2 mb-4 w-48"}"><option disabled="${""}" value="${""}">Choose ...</option>${each(TCPSlaveTag, (Slave, index) => {
...
<select class="${"block text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 text-sm p-2.5 mt-2 mb-4 w-48"}"><option disabled="${""}" value="${""}">Choose ...</option>${NewTriggerModbus[new_trigger_modbus_index].modbusTagOwner != "" && NewTriggerModbus[new_trigger_modbus_index].modbusTagOwnerIndex != -1 ? `${NewTriggerModbus[new_trigger_modbus_index].modbusTagType == 2 && NewTriggerModbus[new_trigger_modbus_index].modbusTagOwnerIndex < TCPSlaveTag.length ? `${each(TCPSlaveTag[NewTriggerModbus[new_trigger_modbus_index].modbusTagOwnerIndex].tag, (Tag, index) => {
                            return `<option${add_attribute("value", Tag.tagName, 0)}>${escape(Tag.tagName)}</option>`;
                          })}` : `${NewTriggerModbus[new_trigger_modbus_index].modbusTagType == 0 && NewTriggerModbus[new_trigger_modbus_index].modbusTagOwnerIndex < TCPMasterTag.length ? `${each(TCPMasterTag[NewTriggerModbus[new_trigger_modbus_index].modbusTagOwnerIndex].tag, (Tag, index) => {
                            return `<option${add_attribute("value", Tag.tagName, 0)}>${escape(Tag.tagName)}</option>`;
                          })}` : `${NewTriggerModbus[new_trigger_modbus_index].modbusTagType == 1 && NewTriggerModbus[new_trigger_modbus_index].modbusTagOwnerIndex < RTUMasterTag.length ? `${each(RTUMasterTag[NewTriggerModbus[new_trigger_modbus_index].modbusTagOwnerIndex].tag, (Tag, index) => {
                            return `<option${add_attribute("value", Tag.tagName, 0)}>${escape(Tag.tagName)}</option>`;
                          })}` : ``}`}`}` : ``}</select></div></td></tr>
...
<select class="${"block text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 text-sm p-2.5 mt-2 mb-4 w-48"}"><option disabled="${""}" value="${""}">Choose ...</option>${changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagOwner != "" && changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagOwnerIndex != -1 ? `${changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagType == 2 && changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagOwnerIndex < TCPSlaveTag.length ? `${each(TCPSlaveTag[changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagOwnerIndex].tag, (Tag, index) => {
                            return `<option${add_attribute("value", Tag.tagName, 0)}>${escape(Tag.tagName)}</option>`;
                          })}` : `${changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagType == 0 && changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagOwnerIndex < TCPMasterTag.length ? `${each(TCPMasterTag[changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagOwnerIndex].tag, (Tag, index) => {
                            return `<option${add_attribute("value", Tag.tagName, 0)}>${escape(Tag.tagName)}</option>`;
                          })}` : `${changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagType == 1 && changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagOwnerIndex < RTUMasterTag.length ? `${each(RTUMasterTag[changed_event_engine_data.config.service_eventEngine_triggerProfile.modbus[modify_trigger_modbus_index].modbusTagOwnerIndex].tag, (Tag, index) => {
                            return `<option${add_attribute("value", Tag.tagName, 0)}>${escape(Tag.tagName)}</option>`;
                          })}` : ``}`}`}` : ``}</select></div></td></tr>
...
<tr><td><p class="${"pl-20 pt-3 text-lg font-light text-right"}">Modbus Tag</p></td>
    <td class="${"pl-4 pt-5"}"><div class="${"flex gap-4"}"><select class="${"block text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 text-sm p-2.5 mt-2 mb-4 w-48"}"><option disabled="${""}" value="${""}">Choose ...</option>${each(TCPSlaveTag, (Slave, index) => {
                            return `<option${add_attribute("value", "TS_" + index, 0)}>${escape(Slave.modbusProfile)}</option>`;
                          })}${each(TCPMasterTag, (TCPMaster, index) => {
                            return `<option${add_attribute("value", "TM_" + index, 0)}>${escape(TCPMaster.modbusProfile)}</option>`;
                          })}${each(RTUMasterTag, (RTUMaster, index) => {
...
<select class="${"block text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 text-sm p-2.5 mt-2 mb-4 w-48"}"><option disabled="${""}" value="${""}">Choose ...</option>${NewActionModbus[new_action_modbus_index].modbusTagOwner != "" && NewActionModbus[new_action_modbus_index].modbusTagOwnerIndex != -1 ? `${NewActionModbus[new_action_modbus_index].modbusTagType == 2 && NewActionModbus[new_action_modbus_index].modbusTagOwnerIndex < TCPSlaveTag.length ? `${each(TCPSlaveTag[NewActionModbus[new_action_modbus_index].modbusTagOwnerIndex].tag, (Tag, index) => {
                            return `<option${add_attribute("value", Tag.tagName, 0)}>${escape(Tag.tagName)}</option>`;
                          })}` : `${NewActionModbus[new_action_modbus_index].modbusTagType == 0 && NewActionModbus[new_action_modbus_index].modbusTagOwnerIndex < TCPMasterTag.length ? `${each(TCPMasterTag[NewActionModbus[new_action_modbus_index].modbusTagOwnerIndex].tag, (Tag, index) => {
                            return `<option${add_attribute("value", Tag.tagName, 0)}>${escape(Tag.tagName)}</option>`;
                          })}` : `${NewActionModbus[new_action_modbus_index].modbusTagType == 1 && NewActionModbus[new_action_modbus_index].modbusTagOwnerIndex < RTUMasterTag.length ? `${each(RTUMasterTag[NewActionModbus[new_action_modbus_index].modbusTagOwnerIndex].tag, (Tag, index) => {
                            return `<option${add_attribute("value", Tag.tagName, 0)}>${escape(Tag.tagName)}</option>`;
                          })}` : ``}`}`}` : ``}</select></div></td></tr>
...
<select class="${"block text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 text-sm p-2.5 mt-2 mb-4 w-48"}"><option disabled="${""}" value="${""}">Choose ...</option>${changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagOwner != "" && changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagOwnerIndex != -1 ? `${changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagType == 2 && changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagOwnerIndex < TCPSlaveTag.length ? `${each(TCPSlaveTag[changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagOwnerIndex].tag, (Tag, index) => {
                            return `<option${add_attribute("value", Tag.tagName, 0)}>${escape(Tag.tagName)}</option>`;
                          })}` : `${changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagType == 0 && changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagOwnerIndex < TCPMasterTag.length ? `${each(TCPMasterTag[changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagOwnerIndex].tag, (Tag, index) => {
                            return `<option${add_attribute("value", Tag.tagName, 0)}>${escape(Tag.tagName)}</option>`;
                          })}` : `${changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagType == 1 && changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagOwnerIndex < RTUMasterTag.length ? `${each(RTUMasterTag[changed_event_engine_data.config.service_eventEngine_actionProfile.modbus[modify_action_modbus_index].modbusTagOwnerIndex].tag, (Tag, index) => {
                            return `<option${add_attribute("value", Tag.tagName, 0)}>${escape(Tag.tagName)}</option>`;
                          })}` : ``}`}`}` : ``}</select></div></td></tr>
