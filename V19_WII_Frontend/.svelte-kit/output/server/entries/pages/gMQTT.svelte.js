import { c as create_ssr_component, v as validate_component, i as add_attribute } from "../../_app/immutable/chunks/index-581edbff.js";
import "classnames";
...
<tr><td><p class="${"pl-4 pt-4 text-lg font-light text-right"}">Data Priority</p></td>
      <td class="${"pl-4 pt-4"}"><div class="${"flex gap-4"}">${validate_component(Radio, "Radio").$$render(
                          ...
                          {
                            value: 0,
                            group: changed_generic_mqtt_data.config.cloud_genericMqtt_profile[modify_index].dataPriority
                          },
                          {
                            group: ($$value) => {
                              changed_generic_mqtt_data.config.cloud_genericMqtt_profile[modify_index].dataPriority = $$value;
                              $$settled = false;
                            }
                          },
                          {
