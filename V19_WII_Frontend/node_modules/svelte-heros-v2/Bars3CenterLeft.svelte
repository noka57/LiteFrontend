...
let viewBox;
let svgpath;
let svgoutline = `<path d="M3.75 6.75H20.25M3.75 12H12M3.75 17.25H20.25" stroke="${color}" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/> `;
...
export let ariaLabel = "bars 3 center left";
</script>
