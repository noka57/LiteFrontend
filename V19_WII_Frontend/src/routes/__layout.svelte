...
{/if}
        			    <SidebarDropdownItem label="Smart Data Logger" href='/sdataloggerV2' active={activeUrl === '/sdataloggerV2'}/>
...
<svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="text-red-500 mr-2 dark:text-pink-500 w-6 h-6">
  ...
  <path d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" stroke-linecap="round" stroke-linejoin="round"></path>
						...
						<SidebarDropdownItem label="Operation" href='/operationV2' active={activeUrl === '/operationV2'}/>
