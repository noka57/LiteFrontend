import { c as create_ssr_component, v as validate_component, h as add_attribute, e as escape } from "../../_app/immutable/chunks/index-e6faea8a.js";
...
const Openvpn = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  <tr class="${"border-b last:border-b-0 bg-white dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600"}"><td class="${"px-6 py-4 whitespace-nowrap font-medium text-gray-900 dark:text-white"}">1</td>
  ...
  <td class="${"px-6 py-4 whitespace-nowrap font-medium text-gray-900 dark:text-white"}">10.123.12.2</td></tr>
...
${validate_component(TableBodyRow, "TableBodyRow").$$render($$result, {}, {}, {
      ...
      ${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, { class: "w-20" }, {}, {
                                  default: () => {
                                    return `<input class="${"block rounded-t-lg text-sm text-gray-900 bg-gray-50 dark:bg-gray-700 border-0 border-b-2 appearance-none dark:text-white focus:outline-none focus:ring-0 peer border-gray-300 dark:border-gray-600 dark:focus:border-blue-500 focus:border-blue-600 px-2.5 pb-2.5 pt-5"}"${add_attribute("value", name, 0)}>`;
                                  }
                                })}
      ${validate_component(TableBodyCell, "TableBodyCell").$$render($$result, {}, {}, {})}`;
                              }
