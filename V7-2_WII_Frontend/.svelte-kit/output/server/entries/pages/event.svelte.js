...
const Event = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    $$settled = true;
    $$rendered = `<table><tr><td class="${"w-36"}"><p class="${"pl-5 pt-5 text-lg font-light text-left"}">Event Engine</p></td>
...
<p class="${"pt-5"}"></p>
 ...
 ${validate_component(Tabs, "Tabs").$$render($$result, { style: "underline" }, {}, {
      default: () => {
        return `${validate_component(TabItem, "TabItem").$$render($$result, { open: true, title: "Profile Settings" }, {}, {
          default: () => {
            return `${validate_component(Accordion, "Accordion").$$render($$result, {}, {}, {
              default: () => {
                return `${validate_component(AccordionItem, "AccordionItem").$$render($$result, { defaultClass }, {}, {
                  header: () => {
                    return `<span slot="${"header"}" class="${"pl-4"}">Common Setting
    </span>`;
                  },
                  default: () => {
                    return `${validate_component(Accordion, "Accordion").$$render($$result, {}, {}, {
...
<tr><td><p class="${"pl-10 pt-4 text-lg font-light text-right"}">Phone Number
  ...
  ${validate_component(AccordionItem, "AccordionItem").$$render($$result, { defaultClass }, {}, {
                  header: () => {
                    return `<span slot="${"header"}" class="${"pl-4"}">Event Trigger
    </span>`;
                  },
                  default: () => {
                    return `${validate_component(Accordion, "Accordion").$$render($$result, {}, {}, {
  ...
  ${validate_component(AccordionItem, "AccordionItem").$$render($$result, { defaultClass }, {}, {
                  header: () => {
                    return `<span slot="${"header"}" class="${"pl-4"}">Action Behavior
    </span>`;
                  },
                  default: () => {
                    return `${validate_component(Accordion, "Accordion").$$render($$result, {}, {}, {
