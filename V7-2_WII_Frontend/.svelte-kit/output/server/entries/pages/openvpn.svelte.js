...
/* empty css                                                                            */import { R as Radio, L as Label } from "../../_app/immutable/chunks/Radio-2dfe5133.js";
import { S as Select } from "../../_app/immutable/chunks/Select-22b3b994.js";
import { T as Textarea } from "../../_app/immutable/chunks/Textarea-2fb7338c.js";
...
${openvpnAuth == "LoginPw" ? `<tr><td><p class="${"pl-20 pt-4 text-lg font-light text-right"}">Client Username</p></td><td class="${"pl-5 pt-5"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", ID, 0)}></td></tr>
