...
const Nat = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    <td class="${"pl-5"}"><div class="${"flex gap-4"}"><label>${``}
  Enable
</label></div></td></tr>
...
${validate_component(Modal, "Modal").$$render(
                      ...
                      {
                        open: ($$value) => {
                          newformModalVC = $$value;
                          $$settled = false;
                        }
                      },
                      {
                        default: () => {
                          return `<form action="${"#"}"><label><input class="${"center"}" type="${"checkbox"}" ${!!newVC_Item[new_vc_index].enable ? "checked" : ""}>
  Enable
</label>

<p class="${"mt-10"}"></p>

<table><tr><td class="${"pl-4"}"><p class="${"pt-4 text-lg font-light text-right"}">Global IP</p></td><td class="${"pl-5 pt-5"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", newVC_Item[new_vc_index].globalIp, 0)}></td></tr>




<tr><td class="${"pl-4"}"><p class="${"pt-4 text-lg font-light text-right"}">Local IP</p></td><td class="${"pl-5 pt-5"}"><input type="${"text"}" class="${"bg-blue-50 border border-blue-500 text-blue-900 dark:text-green-400 placeholder-green-700 dark:placeholder-green-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-green-500"}"${add_attribute("value", newVC_Item[new_vc_index].localIp, 0)}></td></tr>
