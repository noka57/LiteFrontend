<script>
  import { Fileupload, Tabs, TabItem, Radio, Button, Dropdown, DropdownItem, Label, FloatingLabelInput,
...
<Accordion>
  <AccordionItem>
    <span slot="header">Manually Uploaded File</span>
<Table shadow striped={true}>
  <TableHead>
