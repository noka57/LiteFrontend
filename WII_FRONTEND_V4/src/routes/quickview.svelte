...
<Accordion>
  <AccordionItem>
    <span slot="header">DI Status</span>
<Table>
  <TableHead>
  ...
  <AccordionItem>
    <span slot="header">Action Of Clear</span>
    <table>
    <tr>
  ...
  <AccordionItem>
    <span slot="header">DO Status</span>
<Table>
  <TableHead>
    <TableHeadCell>Index</TableHeadCell>
    <TableHeadCell>Name</TableHeadCell>
  ...
  <TableBody class="divide-y">
   ...
   <AccordionItem>
    <span slot="header">DO Control</span>
    <table>
    <tr>
    ...
    <td><p class="pl-40 pt-1 text-lg font-light text-center"> Level Of DO 4</p></td><td class="pl-5 pt-1"><Button color="red">Toggle</Button></td>
     ...
     <AccordionItem>
    <span slot="header">COM X Buffer Display</span>
    <table>
    <tr>
...
<Accordion>
  <AccordionItem>
    <span slot="header">Tag Base View</span>
  ...
  <AccordionItem>
    <span slot="header">Tag Uplink View</span>
